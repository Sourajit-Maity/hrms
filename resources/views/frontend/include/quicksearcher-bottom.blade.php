...
<form id="book_available_form" class="quicksearch-mob" data-parsley-ui-enabled="false"	data-parsley-focus="none" autocomplete="off">
    ...
    $(document).ready(function () {
        ...
        try{
            if($('#home_ca').html() != "Home"){
                $('form').removeClass('home');
                className = 'quicksearch2 home otherPage';
        ...
        $('#book_available').on('click',function(e)
        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    {
                        window.location.href ='{{url('/accommodation#not-available')}}';
