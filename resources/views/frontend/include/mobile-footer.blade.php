...
<footer>
    <div class="footerLeft">
        <ul class="mobileFooter top">
            <li class="copyright">&copy; {{$footer->copyright}}</li>
            <li><a href="{{url('terms-conditions')}}">Terms &amp; Conditions</a></li>
        </ul>
        <ul class="mobileFooter">
            <li class="telephoneFoot">{{$footer->phone_no}}</li>
            <li class="emailFoot"><a href="mailto:{{$footer->email}}">{{$footer->email}}</a></li>
        </ul>
    </div>
...
<script src="{{url('js/mousewheel.js')}}"></script>
<script src="{{url('js/monthpicker.js')}}"></script>
