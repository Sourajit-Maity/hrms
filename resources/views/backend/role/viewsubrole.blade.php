...
<div class="row"><br style="margin-bottom:30px;"/></div>
    ...
    <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6"; align="right">
                <a class="btn btn-success" href="{{ route('add-sub-role') }}"><i class="fa fa-address-card-o" aria-hidden="true"></i></a>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped {{ count($subrole) > 0 ? 'datatable' : '' }} pointer">
                    <thead>
                    <tr>
