$(document).ready(function () {
    ...
    if (typeof window.route_mass_crud_entries_destroy != 'undefined') {
        $('.datatable').siblings('.actions').html('<a href="' + window.route_mass_crud_entries_destroy + '" class="btn btn-xs btn-danger js-delete-selected" onclick="return confirm(\'Are you sure?\');" style="margin-left: 20px;">Delete selected</a>');
    }
